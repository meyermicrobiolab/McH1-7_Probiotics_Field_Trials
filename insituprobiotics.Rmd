...
st1 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS2107_BS2/seqtab.rds") 
st2 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS2172_BS2/seqtab.rds") 
st3 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS2211_BS2/seqtab.rds") 
st4 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS2408_BS2/seqtab.rds") 
...
st3 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS2211_BS2/seqtab.rds") 
st4 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS2408_BS2/seqtab.rds") 
st5 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS1968R_BS1/seqtab.rds")
st6 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS1995_BS1/seqtab.rds") 
st7 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS2051_BS1/seqtab.rds")
st8 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS2696_BS3/seqtab.rds")
st9 <- readRDS("~/Documents/Github/McH1-7_Probiotics_Field_Trials/cutadapt_NS2661_BS3/seqtab.rds")
...
dim(seqtab.nochim)
sum(seqtab.nochim)/sum(st.all)
# Combine read stats from 9 runs and add chimera summary - This does not combine duplicate rows from repeated samples.
stat1 <- read.table("dada_read_stats1.txt",sep="\t",header=TRUE, row.names=1)
stat2 <- read.table("dada_read_stats2.txt",sep="\t",header=TRUE, row.names=1)
stat3 <- read.table("dada_read_stats3.txt",sep="\t",header=TRUE, row.names=1)
stat4 <- read.table("dada_read_stats4.txt",sep="\t",header=TRUE, row.names=1)
stat5 <- read.table("dada_read_stats5.txt",sep="\t",header=TRUE, row.names=1)
stat6 <- read.table("dada_read_stats6.txt",sep="\t",header=TRUE, row.names=1)
stat7 <- read.table("dada_read_stats7.txt",sep="\t",header=TRUE, row.names=1)
stat8 <- read.table("dada_read_stats8.txt",sep="\t",header=TRUE, row.names=1)
stat9 <- read.table("dada_read_stats9.txt",sep="\t",header=TRUE, row.names=1)
